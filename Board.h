...
private:
    ...
    bool checkforRow(const Coordinate &coord,int i) const;
    bool checkforColumn(const Coordinate &coord,int i) const;
...
public:
    ...
    int getStormDamage() const{
        return stormdamage;
    }
    Coordinate getHillCoordinates(){
        return hill;
    }
};
